module github.com/eugenekurasov/security-observability-stack/otel-components/k8sapilogreceiver/e2e_test

go 1.26

require (
	github.com/eugenekurasov/security-observability-stack/otel-components/k8sapilogreceiver v0.0.0
...
replace github.com/eugenekurasov/security-observability-stack/otel-components/k8sapilogreceiver => ../
