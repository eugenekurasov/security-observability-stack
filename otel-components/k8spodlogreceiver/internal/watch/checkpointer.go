...
// Copied unchanged from opentelemetry-collector-contrib's
// internal/k8sinventory/watch package (see observer.go in this directory for
// the full attribution note):
//
//	https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/internal/k8sinventory/watch/checkpointer.go
//
// Included alongside observer.go because it is an unexported, same-package
// dependency observer.go requires to compile.
